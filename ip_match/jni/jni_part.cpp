...
extern "C" {
  JNIEXPORT void JNICALL Java_org_opencv_samples_ipmatch_Sample4View_FindFeatures(JNIEnv* env, jobject thiz, jlong addrGray, jlong addrRgba)
  {
  ...
  JNIEXPORT void JNICALL Java_org_opencv_samples_ipmatch_Sample4View_ORBDetect(JNIEnv* env, jobject thiz, jlong addrGray, jlong addrRgba)
  {
    Mat* pMatGr=(Mat*)addrGray;
    Mat* pMatRgb=(Mat*)addrRgba;
